...
#define STRING_CONFIG_H_AUTHOR "Amos Manneschmidt" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 397 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 32, 10.5, -3.7 }
...
#define INVERT_E0_DIR true // reversed due to e3d geared hemera
